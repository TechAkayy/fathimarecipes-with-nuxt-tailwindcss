# Fathima Recipes with 🏝 Nuxt & TailwindCSS

This repository was live-designed with Vue Designer by following the free YouTube course "**Headless WordPress Made Easy: 🏝 Nuxt + Generative AI with Vue Designer**", which is part of the "**Learn With Vue Designer**" series. Check it out [here](https://pinegrow.com/docs/vue/tutorials-courses/).
...
- Starter Template - [Vue Designer Nuxt Tailwind CSS - Quick start template](https://github.com/pinegrow/pg-nuxt-tailwindcss-custom) (see next section for its Readme)

- Final Output Demo - https://fathimarecipes.com/
